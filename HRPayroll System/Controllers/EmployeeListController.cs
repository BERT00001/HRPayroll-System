    ...
    public class EmployeeListController : Controller
    {
        ...
        public async Task<IActionResult> Edit(EditModel CreateEmp)
        {
            ...
            if(checking != null) 
            {
                ...
                checking.StandardSalary = CreateEmp.StandardSalary;
                checking.DaysAtWor = CreateEmp.DaysAtWor;
                checking.TaxRate = CreateEmp.TaxRate;
        ...
        public async Task<IActionResult> Calculator(CalculatorModel RegularEmployee, string click)
        {
            ...
            if (click == "submit")
            {
                ...
                check.Absences += RegularEmployee.Absences ;
                check.OverallTotal += check.Absences;
        ...
        public async Task<IActionResult> CEdit(EditModel CCreateEmp)
        {
            ...
            if (Cchecking != null)
            {
                ...
                Cchecking.StandardSalary = CCreateEmp.StandardSalary;
                Cchecking.DaysAtWor = CCreateEmp.DaysAtWor;
                Cchecking.TaxRate = CCreateEmp.TaxRate;
